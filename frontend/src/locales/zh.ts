export default {
  translation: {
    ...
    project: {
      ...
      nameTooLong: '项目名称不能超过100个字符',
      ownerTooLong: '负责人名称不能超过100个字符',
    },
    ...
    team: {
      ...
      updateFailed: '团队更新失败',
      deleteFailed: '团队删除失败',
      deleteConfirm: '确定要删除这个团队吗？',
      nameRequired: '请输入团队名称',
      nameTooLong: '团队名称不能超过100个字符',
      leaderTooLong: '负责人名称不能超过100个字符',
    },
    ...
    repository: {
      ...
      selectProject: '选择项目',
      selectTeam: '选择团队',
      selectTeamDisabled: '请先选择项目',
      allProjects: '全部项目',
      allTeams: '全部团队',
      noProject: '无归属项目',
      noTeam: '无归属团队',
      filterByKeyword: '代码库/应用名搜索',
      keywordPlaceholder: '搜索代码库或应用名称...',
