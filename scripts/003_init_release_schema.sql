...
CREATE TABLE IF NOT EXISTS `builds` (
  ...
  INDEX `idx_repo_build` (`repo_id` ASC, `build_number` ASC) USING BTREE,
  INDEX `idx_app_status_created` (`app_id` ASC, `build_status` ASC, `build_created` ASC) USING BTREE,
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='应用构建记录表';
...
CREATE TABLE IF NOT EXISTS `release_batches` (
  ...
  AUTO_INCREMENT = 100
  DEFAULT CHARSET = utf8mb4 COMMENT ='发布批次表';
...
CREATE TABLE IF NOT EXISTS `release_apps` (
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='批次应用关联表';
